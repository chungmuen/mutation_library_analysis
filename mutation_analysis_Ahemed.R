...
#####{enter the path to the folder containing the sequencing results below}#####
seq_file_path = "./"                                                            
ref_seq_name = "ClyF"
################################################################################

library_analysis <- function(seq_result){
...
##run my alignment
file_path <- list.files(path = seq_file_path,pattern = 'fasta')
